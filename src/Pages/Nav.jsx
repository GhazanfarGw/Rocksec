...
import NavLinks from "./Headerw/Navlinks";
...
function Logo({ isScrolled }) {
  ...
  return (
    <>
      {isScrolled ? (
            <header onClick={handleScrollToTop} className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center bg-[#111316] md:py-2 border-b border-[#136690] border-opacity-30">
                ...
                <div className="flex items-center">
                  <div className="flex items-center max-w-screen-xl justify-between mx-auto w-full">
                    <div className="z-20 flex-shrink-0 md:py-2 py-3 items-center duration-500">
                      <a href="/">
                        <img width={90} className='hidden md:block lg:block items-center duration-500 w-40' src='./white.png' alt='favicon.png'/>
                        <img width={80} className='block md:hidden lg:hidden items-center duration-500 w-36' src='./white.png' alt='favicon.png'/>
                      </a>
                    </div>
                    ...
                    <ul className="md:flex hidden items-center w-full justify-end mx-auto">
                      <li>
                        <Link to="/" className="items-center text-sm font-semibold tracking-wider relative h-8 pt-0.5 duration-200 px-4 flex justify-center flex-row hover:text-[#136690] text-white">
                          Home
                        </Link>
                      </li>
                      <NavLinks />
                      <li>
                        <Link to="/careers" className="items-center text-sm font-semibold tracking-wider relative h-8 pt-0.5 duration-200 pr-16 flex justify-center flex-row hover:text-[#136690] text-white">
                            Careers
                          </Link>
                        </li>
                      <div className='flex'>
                        <a 
                          href="/contact" className=" bg-[#136690] shadow-lg hover:bg-opacity-80 hover:font-bold text-white font-semibold items-center relative h-10 text-sm duration-200 px-10 flex rounded-sm ">
                          Contact Us
                        </a>
                      </div>
                    </ul>
              ...
              >
                <li>
                  <Link to="/" className="tracking-wider hover:bg-[#f1f1f1] px-8 py-3 flex flex-row items-center duration-200 hover:text-[#A39896] text-[#fff] border-[#403f68] text-sm font-semibold">
                    Home
                  </Link>
                ...
                <NavLinks />
                <li>
                  <Link to="/careers" className="tracking-wider hover:bg-[#f1f1f1] px-8 py-3 flex flex-row items-center duration-200 hover:text-[#A39896] text-[#fff] text-sm font-semibold">
                    Careers
                  </Link>
                  <div className='border-b border-[#fff] border-opacity-40 mx-3'/>
                </li>
        ...
        <div className="flex items-center">
          <div className="flex items-center max-w-screen-xl justify-between mx-auto w-full">
            <div className="z-30 flex-shrink-0 items-center duration-500 pb-2 md:py-0 py-3">
              <a href="/">
                <img width={120} className='hidden md:block lg:block items-center duration-500 w-48' src='./white.png' alt='favicon.png'/>
                <img width={90} className='block md:hidden lg:hidden items-center duration-500 w-40' src='./white.png' alt='favicon.png'/>
              </a>
            </div>
            <div className="z-20 text-3xl md:hidden pt-3 px-3 text-white" onClick={() => setOpen(!open)}>
...
//         <Preloader />
//       ) : (
//         <nav className="header fixed z-10 justify-center w-full duration-500 mx-auto items-center text-white bg-[#111316] border-b border-[#ffffff] border-opacity-10 shadow-lg">
...
//           </div>
        ...
        //   >
        //     <li>
        //       <Link to="/" className="tracking-wider hover:bg-[#1a1e24] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#136690] text-[#fff] border-[#ffffff] border-opacity-10 text-sm font-semibold">
        //         Home
        //       </Link>
        //     </li>
        //     <NavLinks/>
        //     <li>
        //       <Link to="/careers" className="tracking-wider hover:bg-[#1a1e24] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#136690] text-[#fff] border-[#ffffff] border-opacity-10 text-sm font-semibold">
        //         Careers
        //       </Link>
        //     </li>
        //     <li>
        ...
        //         className="tracking-widest py-3 px-8 flex hover:text-[#136690] flex-row duration-200 justify-between items-center border-b border-[#fff] border-opacity-10 font-bold text-sm" 
