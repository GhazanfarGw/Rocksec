...
const Navbar = () => {
  ...
  return (
    <nav className="header fixed z-10 justify-center w-full duration-500 mx-auto items-center shadow-sm text-white">
      <div className="flex items-center mx-auto justify-center">
        <div className="z-10 pt-3 mx-auto w-full flex justify-between pb-3">
        ...
        <ul className="md:flex hidden uppercase items-center gap-8 bg-yellow-200 text-2xl">
          <li>
        ...
        >
          <li>
            <Link to="/" className="tracking-wider hover:bg-[#1a1e24] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#4AA5F0] text-[#fff] border-[#ffffff] border-opacity-10 text-sm font-semibold">
              Home
            </Link>
          </li>
          <NavLinks/>
          ...
          <li>
            <a
              ...
              className="tracking-widest py-3 px-8 flex hover:text-[#4AA5F0] flex-row duration-200 justify-between items-center border-b border-[#fff] border-opacity-10 font-bold text-sm" 
          ...
          <li>
            <Link to="/" className="hover:bg-[#4AA5F0] border border-[#4AA5F0] items-center relative h-10 mt-8 tracking-wider duration-200 mx-10 justify-center flex rounded-sm">
              Contact us
            </Link>
          </li>
        </ul>
